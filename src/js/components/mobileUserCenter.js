...
export default class MobileUserCenter extends React.Component{
  ...
  render(){
    ...
    usercollection.map((uc,index)=>(
      <Card key={index} title={uc.uniquekey} extra={<a target="" href={'/details/'+uc.uniquekey}>查看</a>} >
        <p>{uc.Title}</p>
      </Card>
    ))
    :
    ...
    usercomments.map((comment,index)=>(
      <Card key={index} title={'于'+comment.datetime+'评论了文章'} extra={<a target="" href={'/details/'+comment.uniquekey}>查看</a>} >
